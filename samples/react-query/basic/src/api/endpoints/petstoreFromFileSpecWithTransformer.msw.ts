...
export const getUpdatePetsResponseMock = (overrideResponse: any = {}): Pet =>
  faker.helpers.arrayElement([
    {
      breed: faker.helpers.arrayElement(['Labradoodle'] as const),
      cuteness: faker.number.int({ min: undefined, max: undefined }),
...
export const getUpdatePetsMockHandler = (overrideResponse?: Pet) => {
  return http.put('*/v:version/pets', async () => {
    await delay(1000);
    return new HttpResponse(
      JSON.stringify(
        overrideResponse !== undefined
